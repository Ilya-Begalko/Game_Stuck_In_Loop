...
public class EnemyBehaviour : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Transform targetToNpc = npc.transform;
        float disToPlayer = Math.Abs(transform.position.x - target.position.x);
        float disToNpc = Math.Abs(transform.position.x - targetToNpc.position.x);
